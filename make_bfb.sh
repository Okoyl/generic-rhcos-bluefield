...
buildbfb() {
    ...
    printf "console=hvc0 console=ttyAMA0 earlycon=pl011,0x13010000 initrd=initramfs ignition.firstboot ignition.platform.id=nvidiabluefield $KERNEL_DBG_ARGS" > "$boot_args2"
